...
RootModule = 'bintils.completers.wsl.psm1'
...
GUID = '566c93ff-4a98-4d58-be36-beed8a204f51'
...
Description = 'Completions for Wsl'
...
PrivateData = @{
    ...
    PSData = @{
        ...
        Tags = @(
            'Wsl', 'Linux', 'Completers', 'Completion', 'ninmonkey', 'Pwsh', 'Ps7'
        )
